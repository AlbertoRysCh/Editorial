...
class CreateTipoeditorialesTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('tipoeditoriales')->insert(array('id'=>'2','nombre'=>'Libro de Investigación','descripcion'=>'Sin descripción'));
        DB::table('tipoeditoriales')->insert(array('id'=>'3','nombre'=>'Libro Académico','descripcion'=>'Sin descripción'));
