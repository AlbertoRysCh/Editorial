        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item request()->is('posibles-clientes')  ? 'has-sub open' : '' }}"><a href="#"><i class="feather icon-bar-chart-2"></i><span class="menu-title" data-i18n="Ventas">Ventas</span></a>
                    ...
                    <ul class="menu-content">
                        <li class="{{ request()->is('clientes') ? 'active' : '' }}"><a href="{{route('posibles.clientes')}}"><i class="fa fa-volume-control-phone"></i><span class="menu-item" data-i18n="Clientes">Registro de Llamadas</span></a>
                        </li>
                    </ul>
                    <ul class="menu-content">
                        <li class="{{ request()->is('clientes') ? 'active' : '' }}"><a href="{{route('posibles.clientes')}}"><i class="fa fa-line-chart"></i><span class="menu-item" data-i18n="Clientes">Vendedor Asesor</span></a>
                        </li>
                    </ul>  
            </li>
                @endif
                ...
                <li class="nav-item"><a href=""><i class="feather icon-users"></i><span class="menu-title" data-i18n="Vendedores">Editorial</span></a>
                    
                    <ul class="menu-content">
                        <li class=""><a href=""><i class="fa fa-address-book-o"></i><span class="menu-item" data-i18n="Clientes">Autores</span></a>
                        </li>
                    </ul>
                    
                    <ul class="menu-content">
                        <li class=""><a href=""><i class="fa fa-bookmark-o"></i><span class="menu-item" data-i18n="Clientes">Áreas</span></a>
                        </li>
                    </ul>
                    
                    <ul class="menu-content">
                        <li class=""><a href=""><i class="fa fa-newspaper-o"></i><span class="menu-item" data-i18n="Clientes">Editorial</span></a>
                        </li>
                    </ul>

                    <ul class="menu-content">
                        <li class=""><a href=""><i class="fa fa-book"></i><span class="menu-item" data-i18n="Clientes">Libros</span></a>
                        </li>
                    </ul>

                    <ul class="menu-content">
                        <li class=""><a href=""><i class="fa fa-bar-chart"></i><span class="menu-item" data-i18n="Clientes">Historial</span></a>
                        </li>
                    </ul>

                    <ul class="menu-content">
                        <li class=""><a href=""><i class="fa fa-folder-open-o"></i><span class="menu-item" data-i18n="Clientes">Archivos</span></a>
                        </li>
                    </ul>

                    <ul class="menu-content">
                        <li class=""><a href=""><i class="fa fa-pencil-square-o"></i><span class="menu-item" data-i18n="Clientes">Actividades</span></a>
                        </li>
                    </ul>
                ...
                <li class="nav-item {{ request()->is('usuarios') || request()->is('productos') ? 'has-sub open' : '' }}"><a href="#"><i class="fa fa-eye"></i><span class="menu-title" data-i18n="Mantenimientos">Gerencia</span></a>
                    <ul class="menu-content list">
                        <li class=""><a href=""><i class="fa fa-address-card-o"></i><span class="menu-item" data-i18n="Usuarios">Coautoria</span></a>
                        </li>
                    </ul>
                    <ul class="menu-content list">
                        <li class=""><a href=""><i class="fa fa-clock-o"></i><span class="menu-item" data-i18n="Usuarios">Pagos por aprobar</span></a>
                        </li>
                    </ul>
                    <ul class="menu-content list">
                        <li class=""><a href=""><i class="fa fa-check-circle-o"></i><span class="menu-item" data-i18n="Usuarios">Pagos aprobados</span></a>
                        </li>
                    </ul>
                    <ul class="menu-content list">
                        <li class=""><a href=""><i class="fa fa-podcast"></i><span class="menu-item" data-i18n="Usuarios">Orden de trabajo</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item {{ request()->is('usuarios') || request()->is('productos') ? 'has-sub open' : '' }}"><a href="#"><i class="feather icon-edit-1"></i><span class="menu-title" data-i18n="Mantenimientos">Mantenimientos</span></a>
                    ...
                    <ul class="menu-content list">
                        <li class=""><a href=""><i class="feather icon-users"></i><span class="menu-item" data-i18n="Usuarios">Asesores de Ventas</span></a>
                        </li>
                    </ul>
                    <ul class="menu-content list">
                        <li class=""><a href=""><i class="feather icon-users"></i><span class="menu-item" data-i18n="Usuarios">Asesores editorial</span></a>
                        </li>
                    </ul>
                </li>
